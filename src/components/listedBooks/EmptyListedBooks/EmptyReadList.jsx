    ...
    return (
        <div className="min-h-[500px] flex items-center justify-center px-4 py-10">
            ...
            >
                ...
                {/* Decorative circles */}
                <div className="absolute -top-5 -right-5 w-14 h-14 rounded-full bg-primary/20 blur-sm"></div>

                <div className="absolute -bottom-5 -left-5 w-16 h-16 rounded-full bg-secondary/20 blur-sm"></div>
                ...
                <p className="max-w-lg mx-auto text-base-content/70 leading-7">
                    No books have made it to your reading list yet.
                    Discover fascinating stories, inspiring ideas, and
                    unforgettable adventures, then add the books you want
                    to read and keep your reading journey organized.
                </p>
